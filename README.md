...
Note: the dashboard's public IP changes when the Fargate task restarts — re-run the lookup in `deploy.sh` (or see [runbooks/aws-operations.md](runbooks/aws-operations.md)) to find the current one.
